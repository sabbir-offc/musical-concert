  ...
  return (
    <div className="text-center">
      ...
      <div className="flex items-center h-screen justify-center">
        <div>
          <div className="relative mx-auto my-10 max-w-md  flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            <div className="relative mx-4 -mt-6 mb-4 px-10 grid h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr from-pink-600 to-pink-400 bg-clip-border text-white shadow-lg shadow-pink-500/40">
